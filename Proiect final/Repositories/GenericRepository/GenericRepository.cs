...
namespace Proiect_final.Repositories.GenericRepository
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : BaseEntity
    {
        protected readonly ApiDbContext _applicationDbContext;
        protected readonly DbSet<TEntity> _table;

        public GenericRepository(ApiDbContext applicationDbContext)
        {
